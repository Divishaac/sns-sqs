...
export class RolesStack extends cdk.Stack {
    ...
    private getEcrGlobalPolicy(): void {
        ...
        const s3UploadBucket = new s3.Bucket( this, 'sns-sqs-bitbucket-s3-upload-artifacts-bucket', {
            versioned: true,
        ...
        new cdk.CfnOutput( this, "bitbucketRole", {
            ...
            exportName: 'sns-sqs-bitbucket-role'
        });
        ...
        new cdk.CfnOutput( this, "bitbucketS3Bucket", {
            ...
            exportName: 'sns-sqs-bitbucket-s3-upload-artifacts-bucket'
        });
    }
    ...
    private createBitBucketUser(): void {
        ...
        new cdk.CfnOutput( this, "userName", {
            ...
            exportName: 'sns-sqs-bitbucket-user'
        });
    }
    ...
    private createPipelineinfra(): void {
        ...
        const topic = new sns.Topic(this, 'sns-sqs-PipelineResultNotification', {
        ...
        const queue = new sqs.Queue(this, 'sns-sqs-pipelineresults');
        ...
        new cdk.CfnOutput( this, "sns-topic-output", {
            ...
            exportName: 'sns-sqs-PipelineResultNotification'
        });
    }
