...
import { SnsSqsPipelineStage } from '../pipeline-stage';
...
export class AlphaPipelineStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        const sourceBucketName = cdk.Fn.importValue( 'sns-sqs-bitbucket-s3-upload-artifacts-bucket');
        ...
        const topicArn = cdk.Fn.importValue( 'sns-sqs-PipelineResultNotification');
        ...
        const alpha_pipeline = new CodePipeline(this, 'alpha-Pipeline', {
            ...
            pipelineName: 'sns-sqs-alpha-pipeline',
            synth: new CodeBuildStep('SynthStep', {
                    ...
                    primaryOutputDirectory: 'app/sns-sqs/cdk.out',
                }
            )
        });
        ...
        //const alpha_stage = alpha_pipeline.addStage( new SnsSqsPipelineStage(this, 'Deploy_to_alpha', { env: alpha_env}, 'alpha'));
